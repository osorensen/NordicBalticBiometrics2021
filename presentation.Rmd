...
Issue: Typical latent variable models are parametric.
...
- The functions $f_{s}\left(\mathbf{x}_{i}\right)$ in the measurement model and $\mathbf{h}\left(\mathbf{w}_{j}\right)$ are arbitrary.
...
- Efficient software for maximum likelihood estimation of generalized additive mixed models: `gamm4`, `mgcv`.
